...
player_list_2011 = fetch_data_pre('SELECT * FROM pre_wc_2011')
player_list_2015 = fetch_data_pre('SELECT * FROM pre_wc_2015')
player_list_2013 = fetch_data_pre('SELECT * FROM pre_ct_2013')
player_list_2017 = fetch_data_pre('SELECT * FROM pre_ct_2017')

# player_list.append(player_list_2011)
# player_list.append(player_list_2013)
# player_list.append(player_list_2015)
# player_list.append(player_list_2017)

performance_list_2011 = fetch_data_post('SELECT * FROM wc_2011')
performance_list_2015 = fetch_data_post('SELECT * FROM wc_2015')
performance_list_2013 = fetch_data_post('SELECT * FROM ct_2013')
performance_list_2017 = fetch_data_post('SELECT * FROM ct_2017')
